...
function createUserFields() {
    ...
    var userImageMessageEl = document.createElement("p");
    userImageMessageEl.id = "message";
    userImageMessageEl.innerText ="Please upload image with filename as username.jpg  (only jpg allowed)";
    userImageMessageEl.style.fontSize = "12px";
    userImageMessageEl.style.fontFamily = "Arial";
    userImageMessageEl.style.marginTop = "-5px";
    userImageMessageEl.style.color = "red";
    ...
    submitBtn.addEventListener('click',function(){
        ...
        if (passValue === confPassValue) {
            var imageFilename = userImageInputEl.files[0].name;
            var validFilename = userNameValue + ".jpg";
    
            if (imageFilename !== validFilename) {
                userImageMessageEl.style.display = "block";
                alert("Image criteria not matched!");
                return; 
            } else {

                userImageMessageEl.style.display = "none";
            }
    ...
    dynamicField.appendChild(userImageMessageEl);
