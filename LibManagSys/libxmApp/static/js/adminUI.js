function createAddBookFields() {
    ...
    var bookQuantityInput = createInput("bookQuantity", "Book Quantity Available");
    ...
    addButton.addEventListener("click", function () {
        var addBookInput = {
            ...
            bookQuantity: bookQuantityInput.value
        };
    ...
    cardContainer.appendChild(bookQuantityInput);
...
function createViewAllBooksFields(available_books2) {
    ...
    var bookQuantityEl = document.createElement('th');
    bookQuantityEl.textContent = "Book Quantity Available";
    headerRow.appendChild(bookTitleEl);
    headerRow.appendChild(bookAuthorEl);
    headerRow.appendChild(bookGenreEl);
    headerRow.appendChild(bookGenreEl);
    headerRow.appendChild(bookQuantityEl);
    ...
    if (Array.isArray(available_books2)) {
        ...
        available_books2.forEach(function (book) {
            ...
            tdEl4.textContent = book.quantity_available;
...
function createViewRequestsFields(){
